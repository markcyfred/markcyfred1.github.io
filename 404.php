...
<head>
    ...
    <title>Top Website & Logo Design Company in Kenya | MywebMark Technologies</title>
            ...
            <div class="menu-area">
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-none d-lg-block">
                            <div class="header-button"> <a href="/contact-us.php"
                                    class="th-btn style3 shadow-none">Make
