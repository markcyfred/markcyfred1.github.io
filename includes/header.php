...
<body>
    ...
    <div class="color-scheme-wrap active">
        ...
        <div class="color-switch-btns">
            <a href="graphicdesign.php" data-color="#684DF4"><img style="width: 50px;" src="assets/img/favicons/logo-design.png" alt="Flame"></a>
            <a href="webdesign.php" data-color="#FF4C60"><img style="width: 50px;" src="assets/img/favicons/ux-design.png" alt="Flame"></a>
            <a href="service.php" data-color="#FF6D3D"><img style="width: 50px;" src="assets/img/favicons/cms.png" alt="Flame"></a>
            <a href="graphicdesign.php" data-color="#FFD54C"><img style="width: 50px;" src="assets/img/favicons/poster-design.png" alt="Flame"></a>
            <a href="s.e.o.php" data-color="#4CAF50"><img style="width: 50px;" src="assets/img/favicons/seo.png" alt="Flame"></a>
        </div>
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center"><button class="th-menu-toggle"><i class="fal fa-times"></i></button>
            <div class="mobile-logo"><a href="index.php"><img style="width: 50px;" src="assets/img/favicons/logo.png" alt=" MywebMark">MywebMark Technologies</a></div>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-links">
                            <ul>
                                ...
                                <li><i class="fas fa-envelope"></i><a href="mailto:mywebmarktechnologies@gmail.com">mywebmarktechnologies@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="menu-area">
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo"><a style="width: 120px;" class="icon-masking" href="index.php"><img src="assets/img/favicons/logo.png" alt=" MywebMark"></a>
                            </div>
                        </div>
                        <div class="col-auto">
                            ...
                            </nav><button type="button" class="th-menu-toggle d-inline-block d-lg-none"><i class="far fa-bars"></i></button>
                        </div>
                        <div class="col-auto d-none d-lg-block">
