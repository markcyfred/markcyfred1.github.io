...
<head>
    ...
    <title>Order Professional Services from MywebMark Technologies - Kenya</title>
    <meta name="author" content="MywebMark Technologies">
    <meta name="description" content="Place your order for professional services from MywebMark Technologies in Kenya. Whether it's website design, logo creation, or SEO optimization, our team is ready to fulfill your requirements.">
    <meta name="keywords" content="Order services, Professional services Kenya, Website design, Logo creation, SEO optimization">
...
<body>
    <div class="fixed-tag">
        <img src="assets/img/Order Now.png" alt="Order Now Web design in kenya">
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input style="color: green; font-weight: bold;" type="text" id="order-name"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input style="color: green;font-weight:bold ;" type="text" id="order-price"
                                            class="form-control" value="" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
