...
<head>
    ...
    <title>Website & Logo Design Company in Kenya | MywebMark Technologies</title>
    <meta name="author" content="MywebMark Technologies">
    <meta name="description"
        content="MywebMark Technologies is the leading Web Design company in Kenya, offering exceptional website design, logo design, SEO, and IT services">
    <meta name="keywords"
        content="MywebMark Technologies, Web design Kenya, Logo design Kenya, SEO Kenya, IT services Kenya">
...
<body>
    <div class="fixed-tag">
        <img src="assets/img/MywebMark.png" alt="mywebmark image missing">
    </div>
                            ...
                            <div class="container">
                                <div class="hero-style2">
                                    <div class="ripple-shape"><span class="ripple-1"></span><span
                                        ...
                                        data-ani="slideinleft" data-ani-delay="0.1s">Webdesign & IT SERVICES</span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6">
                    <div class="title-area mb-35 text-center text-xl-start">
                        <div class="shadow-title">ABOUT US</div><span class="sub-title">
                            <div class="icon-masking me-2"><span class="mask-icon"
                                    ...
                                    src="assets/img/theme-img/title_shape_2.svg" alt="shape"></div>About MywebMark IT
                            SOLUTIONS
                        </span>
                    ...
                    <div class="achivement-tab filter-menu-active indicator-active"><button data-filter=".cat1"
                            class="active" type="button">Award Winning</button> <button data-filter=".cat2"
                    ...
                    <div class="achivement-box-area filter-active-cat1">
                        <div class="filter-item w-100 cat1">
                            <div class="achivement-box">
                                <div class="achivement-box_img"><img style="width: 200px;"
                                        src="assets/img/normal/1695653121926.jpeg" alt="About"></div>
                        ...
                        <div class="filter-item w-100 cat2">
                            <div class="achivement-box">
                                <div class="achivement-box_img"><img style="width: 200px;"
                                        src="assets/img/normal/img-1.jpg" alt="About"></div>
                                <div class="media-body">
        ...
        <div class="container">
            <div class="title-area text-center">
                <div class="shadow-title">PROGRESS</div><span class="sub-title">
                    <div class="icon-masking me-2"><span class="mask-icon"
                            data-mask-src="assets/img/theme-img/title_shape_2.svg"></span> <img
                            src="assets/img/theme-img/title_shape_2.svg" alt="shape"></div>WORK PROGRESS <span
                        style="font-size: small;color: #141D38;">
                        WEB DESIGN
                    </span>
                </span>
                    ...
                    <div class="accordion-area accordion" id="faqAccordion">
                        ...
                        <div class="accordion-card active">
                            <div class="accordion-header" id="collapse-item-2"><button class="accordion-button"
                                    ...
                                    aria-expanded="true" aria-controls="collapse-2">Can MyWebMark assist with e-commerce
            ...
            <div class="cta-sec6 background-image bg-theme" data-bg-src="assets/img/bg/cta_bg_6.jpg">
                <div class="cta-content">
                    <div class="cta-wrapper">
                        <div class="cta-icon"><a href="tel:+254 792 966 620"><img src="assets/img/icon/call.svg"
                                    alt=""></a>
                        </div>
    ...
    <section class="overflow-hidden space" data-bg-src="assets/img/bg/testi_bg_1.jpg" data-overlay="overlay1"
        data-opacity="9">
                    ...
                    <div class="pe-xxl-5 text-xl-start text-center">
                        <div class="title-area mb-35"><span class="sub-title">
                                <div class="icon-masking me-2"><span class="mask-icon"
                                        ...
                                        src="assets/img/theme-img/title_shape_1.svg" alt="shape"></div>CUSTOMER FEEDBACK
                            </span>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testi-card">
                                        ...
                                        <div class="testi-card_profile">
                                            <div class="testi-card_avater"><img src="assets/img/testimonial/john.png"
                                                    alt="testimonial"></div>
                                            <div class="media-body">
                                                <h3 class="testi-card_name">John Muthiani</h3><span
                                                    class="testi-card_desig">Business Manager</span>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testi-card">
                                        ...
                                        <div class="testi-card_profile">
                                            <div style="width: 50px;" class="testi-card_avater"><img
                                                    src="assets/img/testimonial/pc.jpg" alt="testimonial"></div>
                                            <div class="media-body">
                                                <h3 class="testi-card_name">Michael Johnson</h3><span
                                                    class="testi-card_desig">CEO at blue sky enterprise</span>
                                            </div>
                                        </div>
                                        <div class="testi-card_quote"><img src="assets/img/icon/quote_left.svg"
                                                alt="quote"></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testi-card">
                                        ...
                                        <div class="testi-card_profile">
                                            <div class="testi-card_avater"><img style="width: 50px;"
